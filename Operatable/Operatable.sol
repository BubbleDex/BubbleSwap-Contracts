...
contract BUBBLEOperatable {
    ...
    /**
     * @notice Construct a new BUBBLE token
        ...
        external
    {
        ...
        uint96 amount = safe96(rawAmount, "BUBBLE::deposit: amount exceeds 96 bits");
    ...
    function withdraw(uint256 rawAmount) external {
        uint96 amount = safe96(rawAmount, "BUBBLE::withdraw: amount exceeds 96 bits");
